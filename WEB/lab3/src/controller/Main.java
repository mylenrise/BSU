...
public class Main {
    ...
    public static void main( String[] args ){
        try{
            ...
            System.out.println(SetLocale.getLocalizedString(SetLocale.START_COMBINE));
            ...
            System.out.println( SetLocale.getLocalizedString( SetLocale.getLocalizedString(SetLocale.INVALID_ARGS) ) );
            ex.printStackTrace();
            return;
        }
